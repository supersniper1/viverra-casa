...
export const AddWidgetModal: FunctionComponent = () => {
  ...
  return (
    <div className={modalState ? s.Background : `${s.Hidden} ${s.Background}`} onClick={() => AddWidgetClose()}>
          ...
          <div>
            <div className={s.WidgetCell}>
              ...
              <div className={s.TittleAndDescription}>
                ...
                <p className={s.WidgetCellDescription}>Widget for creating simple and clear notes.</p>
              </div>
              <button className={s.Button} onClick={postWidget}><span className={s.ButtonText}>Try it out</span></button>
            </div>
          </div>
          ...
          <div>
            <div className={s.WidgetCell}>
              ...
              <div className={s.TittleAndDescription}>
                ...
                <p className={s.WidgetCellDescription}>Read the chats and have fun.</p>
              </div>
              <button className={s.Button}><span className={s.ButtonText}>Try it out</span></button>
            </div>
          </div>
          <div className={s.Line}></div>
          <div>
            <div className={s.WidgetCell}>
              ...
              <div className={s.TittleAndDescription}>
                ...
                <p className={s.WidgetCellDescription}>Track users and get the news first.</p>
              </div>
              <button className={s.Button}><span className={s.ButtonText}>Try it out</span></button>
            </div>
          </div>
